...
<div class="container">
  <header class="app-header">
    <div class="app-brandrow">
      <span class="app-brand">Pareceres CE — FEUP</span>
    </div>
    <div class="app-subtitle">Análise e emissão de pareceres sobre relatórios pedagógicos de ciclos de estudos</div>
  </header>
  {stepper}
  {body}
</div>
