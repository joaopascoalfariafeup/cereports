...
<head>
  ...
  <title>Assistente de Apoio à Análise de Relatórios de Ciclos de Estudos</title>
...
<div class="container">
  <header class="app-header">
    <div class="app-brandrow">
      <span class="app-brand">Assistente de Apoio à Análise de Relatórios de Ciclos de Estudos</span>
    </div>
